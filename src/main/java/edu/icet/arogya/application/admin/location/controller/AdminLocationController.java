...
public class AdminLocationController {
    ...
    @PostMapping
    public ResponseEntity<@NonNull LocationResponse> create(CreateLocationRequest request) {
        return ResponseEntity.ok(adminLocationService.create(request));
    }

    @PutMapping("/{id}")
    public ResponseEntity<@NonNull LocationResponse> update(@PathVariable UUID id, @RequestBody UpdateLocationRequest request) {
    ...
    public ResponseEntity<@NonNull Void> activate(@PathVariable UUID id) {
        adminLocationService.activate(id);
        return ResponseEntity.ok().build();
    }

    @PostMapping("/{id}/deactivate")
    public ResponseEntity<@NonNull Void> deactivate(@PathVariable UUID id) {
        adminLocationService.deactivate(id);
        return ResponseEntity.ok().build();
    }
}
